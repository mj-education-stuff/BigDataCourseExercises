...
SCHEMA = {
    ...
    "name": "SENSORPACKAGES",
    "fields": [
        {"name": "payload", "doc": "Payload of the message.", "type": "string"},
        {"name": "correlation_id", "doc": "UUID of this message.", "type": "string"},
        {
            "name": "created_at",
...
def generate_sample(sensor_id: str, hdfs_client: InsecureClient) -> None:
    ...
    print(po)
    with AvroWriter(
        client=hdfs_client, hdfs_path=filename, schema=SCHEMA, overwrite=True
    ) as writer:
